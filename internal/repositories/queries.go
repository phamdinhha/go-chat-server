...
const (
	...
	CREATE_CHAT_QUERY    = `INSERT INTO chats (uuid_generate_v4(), room_id, user_id, message, created_at) VALUES ($1, $2, $3, $4, $5) RETURNING id, room_id, user_id, message, created_at RETURNING *`
	LIST_ROOM_QUERY      = `SELECT id, name FROM chat_rooms`
	CREATE_ROOM_QUERY    = `INSERT INTO chat_rooms (uuid_generate_v4(), name) VALUES ($1, $2) RETURNING id, name RETURNING *`
)
